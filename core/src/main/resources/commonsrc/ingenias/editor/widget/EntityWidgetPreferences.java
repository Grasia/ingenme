...
public class EntityWidgetPreferences  implements java.io.Serializable {
  ...
  public  Object getWidget(String attName) throws IllegalAccessException,InstantiationException{
    ...
    Class result=(Class)preferredWidget.get(attName);
    if (result!=null)
  ...
  public void setPreferredOrder(String[] po){
    this.preferredOrder=po;
  }
